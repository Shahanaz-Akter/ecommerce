                                ...
                                <div class="accordion-body">
                                    <form class="row g-3 form-repeater">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="select2 form-select" data-allow-clear="true" name="vendor">
                                                <option value="">Select</option>
                                                <option value="AL">vendor 1</option>
                                                <option value="AL">vendor 1</option>
                                                <option value="AL">vendor 1</option>
                                                <option value="AL">vendor 1</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ 'BIL-' . Carbon\Carbon::now()->timestamp }}" name="bill_id"
                                                disabled />
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="date" class="form-control"
                                                value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="bill_date" />
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="select2 form-select" data-allow-clear="true">
                                                <option value="">Select</option>
                                                <option value="week">Payment 1</option>
                                                <option value="month">Payment 2</option>
                                                <option value="year">Payment 3</option>
                                            </select>
                                        </div>
