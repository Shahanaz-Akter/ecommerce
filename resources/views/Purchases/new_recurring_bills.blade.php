...
@section('title')
    <title>New Recurring Bills</title>
@endsection
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="select2 form-select" data-allow-clear="true">
                                            ...
                                            <option value="AL">Vendor 2</option>
                                            <option value="AK">Vendor 2</option>
                                            <option value="AZ">Vendor 2</option>
                                            <option value="AR">Vendor 2</option>
                                            <option value="CA">Vendor 2</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="select2 form-select" data-allow-clear="true">
                                            <option value="">Select</option>
                                            <option value="week">term 1</option>
                                            <option value="month">term</option>
