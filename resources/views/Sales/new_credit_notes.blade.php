                                    ...
                                    <form class="row g-3 form-repeater">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ 'CN-' . Carbon\Carbon::now()->timestamp }}" name="credit_note_id"
                                                disabled />
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Reference#</label>
                                            <input type="text" class="form-control" name="credit_note_id" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="select2 form-select" data-allow-clear="true">
                                                <option value="">Select</option>
                                                <option value="1">sales person 1</option>
                                                <option value="2">sales person 1</option>
                                                <option value="3">sales person 1</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                                ...
                                                <div class="card-body" style="padding: 0px!important; "">
                                                    ...
                                                    <div class="mb-0">
                                                        <button class="btn btn-primary" data-repeater-create>
                                                            ...
                                                            <span class="align-middle">Add New Line</span>
                                                        </button>
                                                    </div>
